...
{
    public partial class uEducationStates : BaseEditViewListControl
    {
        protected override void BindData(string value)
        {
            uEditViewControl1.BindControl(SiteParams.GetEducationStates(),SiteParams.ColumnNames.Description, 
