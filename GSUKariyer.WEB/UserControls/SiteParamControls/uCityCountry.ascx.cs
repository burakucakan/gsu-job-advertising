...
{
    public partial class uCityCountry : BaseEditViewListControl
    {
        ...
        {
            uEditViewControl1.BindControl(SiteParams.CityCountry.Get(), SiteParams.ColumnNames.Description, 
        ...
        protected override void SetViewData(string value)
        {
            if (String.IsNullOrEmpty(value))
                ...
                uEditViewControl1.SelectedValue=SiteParams.CityCountry.GetCityCountryDescription(value);
        }
