...
{
    public partial class uPersonalCount : BaseEditViewListControl
    {
        protected override void BindData(string value)
        {
            uEditViewControl1.BindControl(SiteParams.GetPersonalCount(),SiteParams.ColumnNames.Description, 
        ...
        protected override void SetViewData(string value)
        {
            ...
            if (valueId.HasValue)
                uEditViewControl1.SelectedValue = SiteParams.GetPersonalCountDescription(valueId.Value);     
            else
