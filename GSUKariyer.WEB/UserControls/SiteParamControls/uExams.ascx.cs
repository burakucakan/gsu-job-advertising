...
{
    public partial class uExams : BaseEditViewListControl
    {
        protected override void BindData(string value)
        {
            uEditViewControl1.BindControl(SiteParams.GetExams(),SiteParams.ColumnNames.Description, 
        ...
        protected override void SetViewData(string value)
        {
            ...
            if (valueId.HasValue)
                uEditViewControl1.SelectedValue = SiteParams.GetExamDescription(valueId.Value);     
            else
