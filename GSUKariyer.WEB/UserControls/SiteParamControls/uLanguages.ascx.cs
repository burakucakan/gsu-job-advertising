...
{
    public partial class uLanguages : BaseEditViewListControl
    {
        protected override void BindData(string value)
        {
            uEditViewControl1.BindControl(SiteParams.GetLanguages(),SiteParams.ColumnNames.Description, 
        ...
        protected override void SetViewData(string value)
        {
            ...
            if (valueId.HasValue)
                uEditViewControl1.SelectedValue = SiteParams.GetLanguageDescription(valueId.Value);        
            else
