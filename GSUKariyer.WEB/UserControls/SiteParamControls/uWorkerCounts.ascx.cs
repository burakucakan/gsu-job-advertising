...
{
    public partial class uWorkerCounts : BaseEditViewListControl
    {
        protected override void BindData(string value)
        {
            uEditViewControl1.BindControl(SiteParams.GetWorkerCounts(),SiteParams.ColumnNames.Description, 
        ...
        protected override void SetViewData(string value)
        {
            ...
            if (valueId.HasValue)
                uEditViewControl1.SelectedValue = SiteParams.GetWorkerCountDescription(valueId.Value);     
            else
