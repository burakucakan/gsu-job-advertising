...
{
    public partial class uContactTypes : BaseEditViewListControl
    {
        protected override void BindData(string value)
        {
            uEditViewControl1.BindControl(SiteParams.GetContactTypes(),SiteParams.ColumnNames.Description, 
        ...
        protected override void SetViewData(string value)
        {
            ...
            if (valueId.HasValue)
                uEditViewControl1.SelectedValue = SiteParams.GetContactTypeDescription(valueId.Value);         
            else
