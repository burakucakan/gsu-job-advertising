...
public partial class UC_Common_PhotoUpload : BaseUserControl
{
    ...
    protected bool PhotoUpload()
    {
        if ((fuPhoto.PostedFile != null) && (this._PhotoPath != String.Empty) && (this._MaxKBSize > 0))
        {
            ...
            try
            {
                this.PhotoName = this.PhotoSaveNameOrg + Util.GetExtension(FileName);
    ...
    {
        this.PhotoName = this.PhotoSaveNameCropped + Util.GetExtension(this.PhotoName);
        ...
        {
            newW = this._SizeW;
            newH = (int)(OrgH / ((int)(OrgW / this._SizeW)));
