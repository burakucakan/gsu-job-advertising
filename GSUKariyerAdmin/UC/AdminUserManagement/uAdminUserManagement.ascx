...
<%@ Register src="~/UC/Common/Paging.ascx" tagname="Paging" tagprefix="uc1" %>
<%@ Register src="~/UC/Common/Error.ascx" tagname="uError" tagprefix="uc2" %>
<%@ Register src="~/UC/Common/Success.ascx" tagname="uSuccess" tagprefix="uc3" %>

<h1>ADMIN KULLANICI HESAPLARI</h1>

<uc3:uSuccess ID="uSuccess1" runat="server" Visible="false" Title="SEÇİLEN ADMIN HESAPLARI SİLİNMİŞTİR" Desc="Seçtiğiniz adminlere ait kayıt bilgileri silinmiştir" />
<uc2:uError ID="uError1" runat="server" Visible="false" Title="SEÇTİĞİNİZ KAYITLAR SİLİNİRKEN HATA OLUŞTU" Desc="Lütfen doğru seçimler yaptığınıza emin olunuz." />
